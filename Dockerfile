...
LABEL Maintainer="Rafael Nascimento <cruz.rafael@hotmail.com>" \
      Description="Lightweight container with Nginx & PHP8 based on Alpine Linux."
...
RUN mkdir -p /etc/nginx/modules-enabled/ \
    ...
    && echo "<h1>It Works!</h1>" >> /var/www/app/index.html
